...
# Tool bubbles in chat (SSE + saved history). Kept high so email lists and
# other MCP output match what the model sees; only clip extreme payloads.
TOOL_UI_DISPLAY_CHARS = 64_000
