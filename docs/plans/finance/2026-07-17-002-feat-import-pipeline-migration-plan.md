...
- Generic CSV mapper is product-required even though HomeBank does not implement Tiller-style mapping; research doc `docs/research/finance/02-manual-import.md` is authoritative for mapper fields.
...
- `tests/test_finance_routes.py` (modify)
- `docs/research/finance/features/import-dedup-review.md` (align notes if behavior locked)
...
- `docs/research/finance/02-manual-import.md`
- `docs/research/finance/features/transaction-import-parsing.md`
- `docs/research/finance/features/import-dedup-review.md`
