...
date: 2026-07-17
deepened: 2026-07-17
origin: "docs/research/finance/features/spending-reports.md; HomeBank hb-report / rep-stats / rep-time"
...
- Odysseus already positions agent Q&A as a differentiator (`docs/research/finance/01-feature-inventory.md`: "Summarize my dining spend last quarter").
...
| KTD4 | No new DB tables in v1; SQLAlchemy `group_by` + `func.sum` on live transactions | Matches docs/research/finance MVP; summary table only if perf becomes an issue |
...
| `docs/research/finance/features/spending-reports.md` | Optional status note after ship |
...
- Odysseus: `integrations/finance/services/reports.py`, `integrations/finance/routes.py`, `integrations/finance/models.py`, `integrations/finance/static/js/index.js`, `src/tools/finance.py`, `src/tool_schemas.py`, `docs/research/finance/features/spending-reports.md`, `docs/research/finance/01-feature-inventory.md`
