...
origin: "HomeBank Assign (hb-assign.h/c) + docs/research/finance/features/rules-auto-categorization.md"
...
- Research target already sketched richer columns in `docs/research/finance/features/rules-auto-categorization.md`.
...
**Goal:** Keep docs/research/finance + plugin README accurate.

**Dependencies:** U2–U5

**Files:**
- `docs/research/finance/features/rules-auto-categorization.md` (mark shipped vs deferred)
...
| Docs | `docs/research/finance/features/rules-auto-categorization.md` |
