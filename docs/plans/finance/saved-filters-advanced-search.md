...
**Related research:** `docs/research/finance/features/search-filter-transactions.md`, `docs/research/finance/features/tags-labels.md`  
...
- Tags — blocked on tags feature (`docs/research/finance/features/tags-labels.md`, Phase 2); leave filter schema hooks only
...
| `docs/research/finance/features/search-filter-transactions.md` | Mark MVP/saved progress |
