...
execution: code
deepened: 2026-07-17
origin: docs/research/finance/features/split-transactions.md
---
...
**Authority.** Product intent from `docs/research/finance/features/split-transactions.md` and Phase 2 inventory (`docs/research/finance/01-feature-inventory.md`). HomeBank semantics are the behavioral reference for validation and report unrolling, not a byte-for-byte port.
...
**Files.**
- `docs/research/finance/features/split-transactions.md` (mark shipped decisions / link plan)
...
- **Effort:** M (matches `docs/research/finance/features/split-transactions.md`; cross-cuts model, reports, UI, agent gate — not L unless templates/rules included).
...
| `docs/research/finance/features/split-transactions.md` | Link decisions |
...
- Origin: `docs/research/finance/features/split-transactions.md`, `docs/research/finance/00-overview.md` (Phase 2 item 11), `docs/research/finance/01-feature-inventory.md`
