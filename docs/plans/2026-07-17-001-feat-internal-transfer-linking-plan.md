...
- `Banking Research/features/spending-reports.md` — “Respect splits and exclude transfers”
- `Banking Research/features/category-budgets.md` — “exclude transfers”
- `Banking Research/features/transaction-categorization.md` — “Transfer categories vs linked transfer pairs — use `is_transfer` flag”
...
| `Banking Research/features/internal-transfer-linking.md` | Optional research mirror |
...
- Odysseus research: `Banking Research/features/{spending-reports,category-budgets,transaction-categorization,import-dedup-review}.md`
