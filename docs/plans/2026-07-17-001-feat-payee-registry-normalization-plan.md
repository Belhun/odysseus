...
| UI | `integrations/finance/static/js/index.js` |
| Docs | `integrations/finance/README.md`; optionally `Banking Research/features/` payee note |
...
5. **Cross-feature:** Recurring bills / subscriptions (Banking Research) should key off `payee_id` once this exists — design FK now even if unused.
