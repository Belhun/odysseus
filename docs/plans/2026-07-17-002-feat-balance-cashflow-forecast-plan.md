...
priority: P2
benefit_verdict: yes
origin: Banking Research/features/cash-flow-forecasting.md
sibling_plans:
  - docs/plans/2026-07-17-001-feat-scheduled-recurring-bills-plan.md
  - docs/plans/2026-07-17-001-feat-internal-transfer-linking-plan.md
homebank_refs:
  - src/rep-balance.c
  - src/rep-balance.h
  - src/hb-report.c
...
**Product Contract preservation:** Bootstrap from Banking Research + HomeBank balance/forecast engines; no prior unified Product Contract for this feature.

---

## Goal Capsule

Ship historical running-balance series (HomeBank Balance report parity) and forward cash-flow projection (HomeBank Stats/Hub forecast + Banking Research forecast) so users and the AI agent can answer "how did my balance move?", "will I overdraft before payday?", and "how much is safe to spend?"

**Authority:** This plan > `Banking Research/features/cash-flow-forecasting.md` and `safe-to-spend.md` for implementation shape. HomeBank is parity reference, not a line-by-line port.
...
3. **Forecast is the agent differentiator.** Competitors (Monarch, Simplifi, PocketGuard) win on forward-looking answers. Banking Research lists cash-flow forecast as Phase 3 item 12 and safe-to-spend as item 14 — both explicitly AI-relevant once recurring exists.
...
| "Safe to spend" (not in HomeBank) | PocketGuard-style from Banking Research | Goal reserves |
...
|-----------|-------|-------|
| **Effort** | **L** overall (Phase A = **M**, Phase B = **M**) | Matches Banking Research forecast **L**; safe-to-spend alone is **S** once recurring exists |
...
- `Banking Research/features/cash-flow-forecasting.md`
- `Banking Research/features/safe-to-spend.md`
- `Banking Research/features/recurring-bills.md`
- `Banking Research/00-overview.md` (Phase 2/3 ordering)
- `Banking Research/01-feature-inventory.md`
- HomeBank `src/rep-balance.c` (historical), `src/hb-report.c` (`report_compute_forecast`)
- Sibling: `docs/plans/2026-07-17-001-feat-scheduled-recurring-bills-plan.md`
- Related: `docs/plans/2026-07-17-001-feat-internal-transfer-linking-plan.md`
