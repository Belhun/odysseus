...
**Parent doc:** `E:/odysseus/docs/research/performance/01-api-server-layer.md` (HTTP layer; Agent 1)  
...
|--------------|--------------|
| `docs/research/performance/01-api-server-layer.md` | HTTP `request_id`, middleware, `perf.jsonl` schema |
