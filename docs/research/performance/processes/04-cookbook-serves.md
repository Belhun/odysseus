...
Wrap `_cookbook_tasks_status_sync`: `task_count`, `live_checks`, `skipped_terminal`, `duration_ms`, `ssh_errors`. Surface via admin diagnostics or `perf.jsonl` (see `docs/research/performance/01-api-server-layer.md`).
