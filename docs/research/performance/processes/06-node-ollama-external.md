...
**Cross-references:** `docs/research/performance/01-api-server-layer.md` (GPU snapshot pattern), `docs/research/performance/processes/02-builtin-mcp.md` (Python MCP siblings), `docs/research/performance/processes/04-cookbook-serves.md` (vLLM/llama-server GPU), `docs/research/performance/05-node-docker-shell-processes.md` (full launch trees)
