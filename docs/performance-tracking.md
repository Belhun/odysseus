...
This guide covers how to run, configure, and validate Odysseus performance tracking on the `feat/performance-tracking` branch (and any branch that merges it).
...
- [Performance tracking roadmap](../Performance%20tracking/00-implementation-roadmap.md) — architecture and phased plan
- [Per-task performance plan](../Performance%20tracking/06-per-task-performance-plan.md) — task metrics design details
